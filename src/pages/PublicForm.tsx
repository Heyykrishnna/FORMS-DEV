...
const THEME_STYLES: Record<FormTheme, { wrapper: string; card: string; accent: string; selected: string; input: string; button: string; label: string }> = {
  ...
  electric_violet: {
    wrapper: 'bg-[#1a0033] text-[#cc99ff] min-h-screen',
    ...
    button: 'bg-[#cc99ff] text-[#1a0033] border-2 border-[#cc99ff] px-8 py-3 font-bold uppercase hover:bg-[#b366ff] transition-all',
    label: 'text-xs font-bold uppercase tracking-wider text-[#cc99ff]/60',
  },
  solar_flare: {
    wrapper: 'bg-[#330000] text-[#ffcc00] min-h-screen',
    ...
    button: 'bg-[#ff3300] text-white border-2 border-[#ff3300] px-8 py-3 font-bold uppercase hover:bg-[#cc2200] transition-all',
    label: 'text-xs font-bold uppercase tracking-wider text-[#ff3300]/60',
  },
  frost_byte: {
    wrapper: 'bg-[#e6f7ff] text-[#006699] min-h-screen',
    ...
    button: 'bg-[#006699] text-white border-2 border-[#006699] px-8 py-3 font-bold uppercase rounded-xl hover:bg-[#004d73] transition-all',
    label: 'text-xs font-bold uppercase tracking-wider text-[#006699]/60',
  },
  nordic_pine: {
    wrapper: 'bg-[#0d1a1a] text-[#d9e6e6] min-h-screen',
    ...
    button: 'bg-[#4d8080] text-[#0d1a1a] border-2 border-[#4d8080] px-8 py-3 font-bold uppercase hover:bg-[#3d6666] transition-all',
    label: 'text-xs font-bold uppercase tracking-wider text-[#4d8080]/60',
  },
  sunset_mirage: {
    wrapper: 'bg-gradient-to-br from-[#ff512f] to-[#dd2476] text-white min-h-screen',
    ...
    button: 'bg-white text-[#dd2476] border-2 border-white px-8 py-3 font-bold uppercase rounded-full hover:bg-white/90 transition-all',
    label: 'text-xs font-bold uppercase tracking-wider text-white/60',
  },
  onyx_stealth: {
    wrapper: 'bg-[#121212] text-[#e0e0e0] min-h-screen',
    ...
    button: 'bg-black text-red-600 border border-red-600 px-8 py-3 font-bold uppercase hover:bg-red-600 hover:text-white transition-all',
    label: 'text-[10px] font-bold uppercase tracking-widest text-[#555]',
  },
  lavender_mist: {
    wrapper: 'bg-[#f3f0ff] text-[#5b21b6] min-h-screen',
    ...
    button: 'bg-[#5b21b6] text-white px-8 py-3 font-bold uppercase rounded-full hover:bg-[#4c1d95] transition-all',
    label: 'text-xs font-bold uppercase tracking-wider text-[#5b21b6]/60',
  },
  emerald_matrix: {
    wrapper: 'bg-[#001a0a] text-[#00ff66] min-h-screen',
    ...
    button: 'bg-[#00ff66] text-black border-2 border-[#00ff66] px-8 py-3 font-bold uppercase hover:bg-[#00cc55] transition-all',
    label: 'text-[10px] font-mono uppercase text-[#00ff66]/50',
  },
  crimson_tide: {
    wrapper: 'bg-[#4a0404] text-[#ffd1d1] min-h-screen',
    ...
    button: 'bg-[#ffd1d1] text-[#4a0404] border-2 border-[#ffd1d1] px-8 py-3 font-bold uppercase hover:bg-[#ffb3b3] transition-all',
    label: 'text-xs font-bold uppercase tracking-wider text-[#ffd1d1]/60',
  },
  golden_hour: {
    wrapper: 'bg-[#fffbeb] text-[#92400e] min-h-screen',
    ...
    button: 'bg-[#f59e0b] text-white border-2 border-white px-8 py-3 font-black uppercase shadow-[4px_4px_0px_#92400e] transition-all',
