...
const TERMS_POINTS = [
  "Acceptance of Terms: By accessing Revox, you agree to be bound by these Terms of Service.",
  "Service Description: Revox provides a platform for building and publishing web forms.",
  "Account Responsibility: You are responsible for maintaining the security of your local storage and form data.",
  "User Conduct: You agree not to use Revox for any illegal or unauthorized purposes.",
  "Intellectual Property: Revox owns the platform code, design, and branding.",
  "User Content: You retain ownership of the data collected through your forms.",
  "Data Hosting: Revox currently operates as a client-side focused application with local storage persistence.",
  "No Warranty: Revox is provided 'as is' without any express or implied warranties.",
  "Limitation of Liability: Revox is not liable for data loss or service interruptions.",
  ...
  "Open Source: Some components of Revox may be subject to open-source licenses.",
  "Logo Usage: Revox trademarks may not be used without explicit permission.",
  "Feedback: Any feedback provided may be used by Revox without compensation.",
  "Confidentiality: You must respect the confidentiality of any non-public info shared.",
  "Indemnification: You agree to indemnify Revox from claims related to your form usage.",
  "No Agency: No partnership or agency relationship is created by using Revox.",
  "Entire Agreement: These terms constitute the whole agreement between you and Revox.",
  ...
  "Force Majeure: Revox is not liable for failures due to circumstances beyond control.",
  ...
  "Form Retention: Revox does not currently offer a server-side archival service.",
  ...
  "Reporting Violations: Users should report any malicious forms to Revox support.",
  "Local Laws: You must comply with your local laws regarding data collection.",
  "Contact: Legal inquiries can be directed to legal@revox.com.",
  ...
  "Branding: Revox branding must remain visible on free-tier forms.",
  ...
  "Final Agreement: Usage of Revox constitutes your final acceptance of these points."
];
...
const PRIVACY_POINTS = [
  ...
  "Data Usage: Data collected is used solely for the operation of the Revox platform.",
  ...
  "HTTPS: All traffic to and from Revox is forced over secure HTTPS connections.",
  ...
  "Contact Privacy: Inquiries regarding privacy can be sent to privacy@revox.com.",
        ...
        <nav className="border-b-2 border-foreground fixed top-0 w-full bg-background z-50">
          <div className="container mx-auto flex items-center justify-between px-4 py-4">
            <Link to="/" className="text-2xl font-black tracking-widest uppercase flex items-center gap-2">
              <ChevronLeft className="h-6 w-6" /> REVOX<span className="text-accent">.</span>
            </Link>
        ...
        <main className="pt-32 pb-24 container mx-auto px-4 max-w-5xl">
          <div className="mb-16">
            ...
            <p className="text-xl font-bold text-foreground/60 uppercase max-w-2xl leading-tight border-l-4 border-foreground pl-6">
              Last Updated: February 2026. These documents outline the bold rules and raw security standards that power Revox.
            </p>
          </div>
                  ...
                  <div className="bg-foreground text-background p-10 border-brutal">
                    ...
                    <div className="space-y-6">
                      <p className="text-sm font-bold uppercase leading-relaxed">
                        Revox is built on a foundation of transparency. We don't hide behind complex legalese. Our security infrastructure is built using the same principles as our design: bold, raw, and highly effective.
                      </p>
